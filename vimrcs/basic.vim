...
" Number and set it as relative number
set number
set relativenumber
...
" highlight TrailingWhitespace ctermbg=13 guifg=red
autocmd BufWinEnter * highlight ExtraWhitespace ctermfg=yellow
autocmd InsertEnter * highlight ExtraWhitespace ctermfg=yellow
autocmd InsertLeave * highlight ExtraWhitespace ctermfg=yellow
" highlight IgnoredWhitespace  ctermbg=53 guifg=red
...
vnoremap <C-V> :r !xclip -o -sel c<CR>
